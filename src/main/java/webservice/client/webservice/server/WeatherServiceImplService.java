 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://server.webservice/", wsdlLocation = "http://localhost:8085/ws_server/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://server.webservice/", "WeatherServiceImplService");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://server.webservice/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
