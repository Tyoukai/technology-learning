 ...
 * generated in the webservice.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCityname_QNAME = new QName("http://server.webservice/", "getWeatherByCityname");
    private final static QName _GetWeatherByCitynameResponse_QNAME = new QName("http://server.webservice/", "getWeatherByCitynameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice/", name = "getWeatherByCityname")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice/", name = "getWeatherByCitynameResponse")
